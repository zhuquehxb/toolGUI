...
class Application_ui(Frame):
    ...
    def createWidgets(self):
        ...
        self.TabStrip1__Tab1Lbl = Label(self.TabStrip1__Tab1, text='Please add widgets in111 code.')
        ...
        self.TabStrip1__Tab2Lbl = Label(self.TabStrip1__Tab2, text='Please add widgets in222 code.')
